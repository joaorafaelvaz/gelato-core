...
const APP_URL = process.env.DATABASE_URL ?? 'postgresql://gelato_app:app_pw@localhost:5432/gelato'
const OWNER_URL =
  process.env.DATABASE_URL_OWNER ?? 'postgresql://gelato_owner:owner_pw@localhost:5432/gelato'
